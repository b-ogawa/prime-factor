...
export class SIQSCoordinator extends EventEmitter {
    ...
    runPipeline(N, maxWorkers, sessionId, session, workerPool) {
        this.active = true;
        this.activeTarget = N;
        ...
        let targetCount = fbPrimes.length + 15;
        ...
        this.emit('siqsTaskGenerated', taskMsg);
    }
    ...
    handleRelation(data) {
        ...
        while (this.active) {
            ...
            let wasmMemory = new Uint8Array(WasmAdapter.wasm.memory.buffer, ptr, SLOT_SIZE);
